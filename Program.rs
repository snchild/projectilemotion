...
fn main() {
    ...
    let mut greatest_time = 0.0;
    let mut deg_for_most_t = 0.0;
    let mut v0_for_most_t = 0.0;
    ...
    loop {
        ...
        if flight_time > greatest_time {
            greatest_time = flight_time;
            v0_for_most_t = v0;
    ...
    println!("The longest the projectile was in the air was {} seconds. This was when it was launched at {} meters/second, oriented {} degrees from the horizontal.", greatest_time, v0_for_most_t, deg_for_most_t);
}
